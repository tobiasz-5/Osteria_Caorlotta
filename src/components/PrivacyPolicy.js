    ...
    <>
      ...
      <div className="privacy-policy container">
        ...
        <section lang="en">
          ...
          <p>
            <strong>Osteria Caorlotta</strong> – Lungarno Amerigo Vespucci, 34r – 50123 Florence (Italy)
            – e‑mail: <a href="mailto:osteriacaorlotta@gmail.com">osteriacaorlotta@gmail.com</a>
          </p>

          <h2>2. Data Recipients</h2>
          <p>
            External processors (Art. 28 GDPR): hosting (Vercel Inc.), e‑mail (Google Workspace), IT consultants,
            Formspree Inc. (contact form) and, upon consent, Google LLC (Google Maps).
          </p>
          ...
          <p>
            ...
            data to the USA (EU‑US DPF or SCC). Formspree sets a session cookie (<code>fs_csrftoken</code>) for CSRF protection.
          </p>
